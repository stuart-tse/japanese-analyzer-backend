...
export const TEXTS = {
  AUTH: {
    ...
    ROLE_REQUIRED: "您的角色无权执行此操作",
    PERMISSION_REQUIRED: "您没有执行此操作所需的权限",
  },
  PROFILE: {
  ...
  ADMIN: {
    ROLES_REQUIRED: "请提供至少一个角色",
    INVALID_ROLES: "没有有效的角色。有效角色: ",
    CANNOT_REMOVE_OWN_ADMIN: "不能移除自己的管理员角色",
    LAST_ADMIN: "系统至少需要一个管理员",
    LIST_FAILED: "获取用户列表失败",
    GET_FAILED: "获取用户详情失败",
    UPDATE_ROLES_FAILED: "更新用户角色失败",
    STATS_FAILED: "获取系统统计失败",
    AUDIT_LOG_FAILED: "获取审计日志失败",
  },
  TEACHER: {
    STATS_FAILED: "获取教师统计失败",
    COURSE_NOT_FOUND: "课程不存在",
    NOT_OWNER: "您无权操作此课程",
    LIST_FAILED: "获取课程列表失败",
    CREATE_FAILED: "创建课程失败",
    UPDATE_FAILED: "更新课程失败",
    DELETE_FAILED: "删除课程失败",
    DELETE_HAS_PROGRESS: "无法删除：已有学生学习进度",
    LESSON_NOT_FOUND: "课时不存在",
    LESSON_NUMBER_CONFLICT: "课时编号已存在",
  },
  CREATOR: {
    STATS_FAILED: "获取创作者统计失败",
    LIST_FAILED: "获取内容列表失败",
    IMPORT_FAILED: "导入内容失败",
    UPDATE_FAILED: "更新内容失败",
    STATUS_UPDATE_FAILED: "更新内容状态失败",
    ARCHIVE_FAILED: "归档内容失败",
    RETRY_FAILED: "重试失败",
    ANALYTICS_FAILED: "获取分析数据失败",
    NOT_OWNER: "您无权操作此内容",
  },
} as const;
