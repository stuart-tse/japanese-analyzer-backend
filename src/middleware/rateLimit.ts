...
export function rateLimit(overrides?: Partial<RateLimitConfig>) {
...
interface TierLimits {
  free: { maxTokens: number; refillRate: number };
  pro: { maxTokens: number; refillRate: number };
  premium: { maxTokens: number; refillRate: number };
}

export function tierBasedRateLimit(limits: TierLimits) {
