...
router.post('/create', async (req, res) => {
    try {
        ...
        // Create subscription
        const result = await subscriptionService.createSubscription(userId, tier, period, paymentMethodId);
        res.json({
            success: true,
...
router.post('/cancel', async (req, res) => {
    try {
        ...
        const subscription = await subscriptionService.cancelSubscription(userId, immediately === true);
        res.json({
            success: true,
            subscription,
            message: immediately
...
router.post('/update', async (req, res) => {
    try {
        ...
        const subscription = await subscriptionService.updateSubscription(userId, tier, period);
        res.json({
            success: true,
            subscription,
