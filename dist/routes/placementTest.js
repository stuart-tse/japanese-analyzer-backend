...
router.post('/', async (req, res) => {
    try {
        ...
        const skillBreakdown = Object.entries(scoresBySkill).reduce((acc, [skill, scores]) => {
 ...
 */
function calculateRecommendedLevel(scoresByLevel) {
    const levels = ['N5', 'N4', 'N3', 'N2', 'N1'];
...
//# sourceMappingURL=placementTest.js.map