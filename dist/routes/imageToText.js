...
const DEFAULT_GEMINI_VISION_URL = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent';
const DEFAULT_PROMPT = '请提取并返回这张图片中的所有日文文字。提取的文本应保持原始格式，但不要输出换行符，用空格替代。不要添加任何解释或说明。';
...
const router = Router();
router.post('/', rateLimit({ maxTokens: 10, refillRate: 0.5 }), async (req, res) => {
    try {
